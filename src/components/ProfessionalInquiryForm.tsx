...
export default function ProfessionalInquiryForm() {
  ...
  const control = "min-h-12 rounded-control border border-[var(--border)] bg-[#07111a] px-4 py-3 text-[var(--foreground)] outline-none transition focus:border-[var(--cry-accent-magenta)] focus:shadow-[0_0_0_2px_rgba(255,51,204,.15)]";
  return (
