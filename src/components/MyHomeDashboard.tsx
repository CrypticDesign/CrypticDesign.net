...
export default function MyHomeDashboard({ initialAuthenticated = true, accountAdmissionMode = "closed" }: { initialAuthenticated?: boolean; accountAdmissionMode?: AccountAdmissionMode }) {
  ...
  return (
    <main className="my-home">
      <section className="visual-hero home-hero" data-section-accent="indigo" aria-labelledby="my-home-title">
        <PersonalSpacePanel
      ...
      {authenticated ? (
        <div className="shell my-home-stack">
          <section className="my-home-priority-grid" data-section-accent="violet" aria-label="Identity and next actions">
          ...
          <section data-section-accent="magenta" aria-labelledby="continue-title">
          ...
          <section className="my-home-detail-grid" data-section-accent="blue" aria-label="Library and progress">
          ...
          <section className="my-home-detail-grid" data-section-accent="cyan" aria-label="Collections and participation">
          ...
          <section data-section-accent="indigo" aria-labelledby="account-utilities-title">
        ...
        <section className="shell my-home-signed-out" data-section-accent="indigo" aria-labelledby="signed-out-title">
