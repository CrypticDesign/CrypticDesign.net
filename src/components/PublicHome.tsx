...
export default function PublicHome({ accountAdmissionMode }: { accountAdmissionMode: AccountAdmissionMode }) {
  return (
    <main className="public-home public-home-portal">
      <section className="visual-hero public-home-hero public-home-portal__hero" aria-labelledby="public-home-title">
        <div className="visual-hero__image"><Image src="/images/entertainment-hero.png" alt="A luminous network of worlds representing the Cryptic Design ecosystem" fill priority sizes="100vw" /></div>
        ...
        <div className="visual-hero__content public-home-portal__hero-content">
          ...
          <span className="kicker !text-[#ffd400]">One platform. Many paths.</span>
      ...
      <div className="shell public-home-portal__stack">
        <section className="public-home-portal__featured" aria-labelledby="featured-now-title">
        ...
        <section className="public-home-portal__entries" aria-labelledby="ways-in-title">
        ...
        <section className="public-home-portal__utility-grid" aria-label="Platform access and status">
          <article className="portal-utility portal-utility--identity"><span className="kicker !text-[#ffd400]">Public by default</span><h2>Explore without an account.</h2><p>Entertainment, studio work, articles, and approved releases remain available through the public platform.</p><Link href="/entertainment">Start exploring <span aria-hidden="true">→</span></Link></article>
        ...
        <section className="public-home-portal__studio" aria-labelledby="studio-strip-title">
          <div><span className="kicker !text-[#ffd400]">From the studio behind the platform</span><h2 id="studio-strip-title">Independent worlds, experiences, and systems.</h2><p>Cryptic Design combines original entertainment with product thinking, interaction design, interface systems, and creative technology.</p></div>
