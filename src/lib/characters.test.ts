...
test("validates privacy-safe public profile limits", () => {
  assert.deepEqual(validateCharacterInput({ name: " Nova ", archetype: "Navigator", bio: " Hi " }), { name: "Nova", handle: "nova", archetype: "Navigator", bio: "Hi", portraitUrl: null, affiliation: null, presence: "offline", discoverable: false, visibility: "private", publicationConsent: false });
