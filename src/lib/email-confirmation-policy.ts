...
export type EmailConfirmationPolicy = {
  type: EmailOtpType;
  allowed: boolean;
  destination: "/account" | "/account/reset-password" | "/account/accept-invitation";
  kind: "account-security" | "admission" | "admission-required";
};
...
const policies: Readonly<Record<EmailOtpType, EmailConfirmationPolicy>> = {
  ...
  invite: { type: "invite", allowed: true, destination: "/account/accept-invitation", kind: "admission" },
