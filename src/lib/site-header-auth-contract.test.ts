...
test("primary navigation exposes contextual Sign In or Account directly without a dropdown", async () => {
  ...
  assert.match(header, /href: "\/community", label: "Community", tone: "periwinkle"/);
  assert.match(header, /href: "\/professional", label: "Professional", tone: "lavender"/);
...
test("primary Explore and its destination drawer expose independent controls", async () => {
  ...
  assert.match(globals, /\.entertainment-navigation__item-drawer\[data-theme="periwinkle"\]>\.entertainment-navigation__item\{--nav-accent:var\(--cry-spectrum-periwinkle\)\}/);
  assert.match(globals, /\.entertainment-navigation__item-drawer\[data-theme="lavender"\]>\.entertainment-navigation__item\{--nav-accent:var\(--cry-spectrum-lavender\)\}/);
  ...
  assert.match(globals, /data-section-theme="orchid"/);
