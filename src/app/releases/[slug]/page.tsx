    ...
    <main>
      ...
      <div className="shell page-stack">
        ...
        {product && <section className="panel grid gap-6 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div><span className="kicker !text-[var(--cry-accent-magenta)]">Part of the {product.title} franchise</span><h2 className="section-title mt-2">Continue into the wider universe.</h2><p className="max-w-2xl text-muted-foreground">{product.summary}</p></div>
