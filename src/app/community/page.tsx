    ...
    <main className="community-portal community-explore">
      ...
      <div className="shell community-portal__stack community-explore__stack">
        ...
        <section className="explore-portal__continuum" data-section-accent="magenta" aria-labelledby="community-explore-platform-title">
          ...
          <nav aria-label="Explore beyond Community"><Link href="/entertainment">Explore Entertainment <span aria-hidden="true">→</span></Link><Link href="/releases">Browse Releases <span aria-hidden="true">→</span></Link><Link href="/account/create">Request Access <span aria-hidden="true">→</span></Link></nav>
        </section>
