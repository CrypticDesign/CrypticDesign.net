  ...
  return (
    <main className="community-portal community-explore">
      ...
      <div className="shell community-portal__stack community-explore__stack">
        ...
        <section className="explore-portal__continuum explore-portal__continuum--cta" data-section-accent="magenta" aria-labelledby="community-explore-platform-title">
          ...
          <nav className="hero-actions explore-portal__continuum-actions" aria-label="Explore beyond Community">
            ...
            <Link href="/account/create" className="button home-primary-cta">Request Access</Link>
          </nav>
        </section>
