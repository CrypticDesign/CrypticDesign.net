...
export default async function CommunityPage() {
  ...
  return (
    <main className="community-portal community-explore">
      <section className="visual-hero community-portal__hero" data-section-accent="magenta" aria-labelledby="community-title">
      ...
      <div className="shell community-portal__stack community-explore__stack">
        ...
        <section className="community-portal__code" data-section-accent="magenta" aria-labelledby="community-code-title"><div><span className="kicker">Our community. Our code.</span><h2 id="community-code-title">Participation with clear boundaries.</h2></div><ul><li><strong>Be respectful</strong><span>Treat people and their work with care.</span></li><li><strong>Be inclusive</strong><span>Design for welcome, access, and belonging.</span></li><li><strong>Be creative</strong><span>Share ideas without taking ownership.</span></li><li><strong>Protect the space</strong><span>Safety and privacy outrank engagement.</span></li></ul></section>
      </div>
    </main>
  );
}
