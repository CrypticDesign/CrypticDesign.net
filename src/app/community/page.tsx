  ...
  return (
    <main className="community-portal community-explore">
      ...
      <div className="shell community-portal__stack community-explore__stack">
        ...
        <section className="explore-portal__continuum community-explore__platform-cta" data-section-accent="magenta" aria-labelledby="community-explore-platform-title">
          ...
          <nav className="hero-actions community-explore__platform-actions" aria-label="Explore beyond Community">
            ...
            <Link href="/account/create" className="button home-primary-cta community-explore__platform-primary">Request Access</Link>
          </nav>
        </section>
