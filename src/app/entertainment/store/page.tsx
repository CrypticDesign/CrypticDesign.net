  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-12 sm:px-6">
      <header className="flex flex-col gap-3">
        <span className="text-[10px] font-bold uppercase tracking-[.1em] text-accent-violet">
          Store / preview
        </span>
      ...
      <section className="panel flex flex-col gap-4 p-7 sm:p-10">
        <span className="kicker !text-[var(--cry-accent-magenta)]">Want to be told when it opens?</span>
