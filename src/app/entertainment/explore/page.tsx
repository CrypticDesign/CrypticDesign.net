...
const featuredPaths = [
  ...
  { href: "/entertainment/cinema", image: "/images/entertainment-hero.png", icon: "media" as const, accent: "indigo", type: "Stories & video", title: "Cinema", body: "Watch public films, transmissions, trailers, and visual storytelling as they become available." },
...
const categories: readonly { href: string; icon: EcosystemPortalIconName; title: string; body: string; accent: string }[] = [
  ...
  { href: "/audio", icon: "listen", title: "Music & audio", body: "Scores, signals, songs, and sound", accent: "indigo" },
  ...
  { href: "/professional/creators", icon: "crew", title: "Creators", body: "People and disciplines behind the work", accent: "blue" },
];
...
export default async function ExplorePage({ searchParams }: { searchParams: Promise<{ genre?: string }> }) {
  ...
  return <main className="explore-portal">
    ...
    <div className="shell explore-portal__stack">
      <section id="featured-experiences" data-section-accent="indigo" aria-labelledby="featured-experiences-title">
      ...
      <section data-section-accent="violet" aria-labelledby="explore-categories-title">
      ...
      <section id="playable-catalog" data-section-accent="magenta" aria-labelledby="playable-catalog-title">
