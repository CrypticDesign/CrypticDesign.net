...
const featuredPaths = [
  { href: "/products/singularis", image: "/images/singularis-marketing-02.jpg", icon: "play" as const, accent: "cyan", type: "Playable sample", title: "Singularis", body: "Enter the public browser prototype and follow the evolving science-fiction universe." },
  { href: "/entertainment/listening-rooms", image: "/images/signal-systems.png", icon: "listen" as const, accent: "gold", type: "Music & audio", title: "Listening rooms", body: "Move through approved tracks, scores, signals, and connected sonic work." },
  { href: "/entertainment/cinema", image: "/images/entertainment-hero.png", icon: "media" as const, accent: "magenta", type: "Stories & video", title: "Cinema", body: "Watch public films, transmissions, trailers, and visual storytelling as they become available." },
  { href: "/entertainment/creative-labs", image: "/images/professional-case.png", icon: "discover" as const, accent: "violet", type: "Experiments", title: "Creative Labs", body: "See approved prototypes, studies, and creative-technology work without fictional activity." },
] as const;

const categories: readonly { href: string; icon: EcosystemPortalIconName; title: string; body: string; accent: string }[] = [
  { href: "#playable-catalog", icon: "play", title: "Games", body: "Playable samples and future experiences", accent: "cyan" },
  { href: "/products", icon: "worlds", title: "Worlds", body: "Original properties and connected releases", accent: "gold" },
  { href: "/audio", icon: "listen", title: "Music & audio", body: "Scores, signals, songs, and sound", accent: "magenta" },
  { href: "/entertainment/cinema", icon: "media", title: "Stories & video", body: "Films, trailers, transmissions, and series", accent: "violet" },
  { href: "/entertainment/creative-labs", icon: "discover", title: "Experiments", body: "Prototypes and creative technology", accent: "cyan" },
  { href: "/professional/creators", icon: "crew", title: "Creators", body: "People and disciplines behind the work", accent: "gold" },
];
...
export default async function ExplorePage({ searchParams }: { searchParams: Promise<{ genre?: string }> }) {
  ...
  return <main className="explore-portal">
    <section className="visual-hero explore-portal__hero" aria-labelledby="explore-title">
      ...
      <div className="visual-hero__content explore-portal__hero-content">
        ...
        <span className="kicker !text-[#ffd400]">Discover. Play. Watch. Listen.</span>
    ...
    <div className="shell explore-portal__stack">
      <section id="featured-experiences" aria-labelledby="featured-experiences-title">
      ...
      <section id="playable-catalog" aria-labelledby="playable-catalog-title">
      ...
      <section className="explore-portal__continuum" aria-labelledby="explore-continuum-title">
        <div><span className="kicker !text-[#ffd400]">Every path connects</span><h2 id="explore-continuum-title">Move through the ecosystem at your pace.</h2><p>Public exploration remains independent from account admission, invitations, subscriptions, and payment systems.</p></div>
