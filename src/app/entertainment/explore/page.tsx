...
const featuredPaths = [
  ...
  { href: "/entertainment/cinema", image: "/images/entertainment-hero.png", icon: "media" as const, accent: "periwinkle", type: "Stories & video", title: "Cinema", body: "Watch public films, transmissions, trailers, and visual storytelling as they become available." },
  { href: "/entertainment/creative-labs", image: "/images/professional-case.png", icon: "discover" as const, accent: "lavender", type: "Experiments", title: "Creative Labs", body: "See approved prototypes, studies, and creative-technology work without fictional activity." },
] as const;
...
const categories: readonly { href: string; icon: EcosystemPortalIconName; title: string; body: string; accent: string }[] = [
  ...
  { href: "/audio", icon: "listen", title: "Music & audio", body: "Scores, signals, songs, and sound", accent: "periwinkle" },
  { href: "/entertainment/cinema", icon: "media", title: "Stories & video", body: "Films, trailers, transmissions, and series", accent: "lavender" },
  { href: "/entertainment/creative-labs", icon: "discover", title: "Experiments", body: "Prototypes and creative technology", accent: "violet" },
  { href: "/professional/creators", icon: "crew", title: "Creators", body: "People and disciplines behind the work", accent: "orchid" },
];
...
export default async function ExplorePage({ searchParams }: { searchParams: Promise<{ genre?: string }> }) {
  ...
  return <main className="explore-portal">
    ...
    <div className="shell explore-portal__stack">
      ...
      <section data-section-accent="periwinkle" aria-labelledby="explore-categories-title">
      ...
      <section id="playable-catalog" data-section-accent="lavender" aria-labelledby="playable-catalog-title">
      ...
      <section className="explore-portal__continuum" data-section-accent="violet" aria-labelledby="explore-continuum-title">
