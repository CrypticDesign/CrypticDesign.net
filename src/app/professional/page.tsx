...
export default function ProfessionalHub() {
  return <main>
    ...
    <div className="shell page-stack">
      ...
      <section id="founder" className="feature-split" aria-labelledby="founder-title"><div className="feature-split__content"><span className="kicker">Founder / Senior Practice</span><h2 id="founder-title">{copy.founder.title}</h2><p>{copy.founder.lead}</p><Link href="/professional/case-studies" className="text-link">View Case Studies</Link></div><div className="feature-split__image"><Image src="/images/singularis.png" alt="Abstract Cryptic Design system artwork" fill sizes="(max-width:900px) 100vw, 40vw" /></div></section>
