  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6">
      ...
      <p className="max-w-xl text-muted-foreground">
        Musicians, artists, writers, and developers can apply to contribute to
        Cryptic Design releases and productions. Each application is reviewed
        individually for identity, portfolio, fit, and permission to share the
        work.
      </p>
