  ...
  return (
    <main className="shell page-stack">
      <header className="grid gap-6 border-b border-[var(--border)] pb-10 pt-6 lg:grid-cols-[1fr_.7fr] lg:items-end">
        <div><span className="kicker !text-[var(--cry-spectrum-magenta)]">Professional inquiry</span><h1 className="display-title !text-[clamp(2.5rem,7vw,5.5rem)]">Start with the problem.</h1></div>
