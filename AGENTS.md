...
## Locked platform model (SITEMAP v16 — Robert's current direction, 2026-07-13)

- **The v16 "Three Front Doors" section on FigJam board `oen38yFKbFtgqx9LQKn38Y` is the canonical IA.** It preserves the release-platform model while defining clear personal, audience, and business entry points.
...
- **Products & Franchises** (`/products`): Singularis, Lifa, Cryptic Design Audio, and Image of the Day reclassified into Creative Labs / Visual Studies. **Soundwave is tombstoned and is not a product, destination, or public brand surface.**
...
- **Native audio system** (`/audio`): CrypticDesign.net-owned shared player, catalog, artist profiles, playlists, submissions, and analytics preview shells. Do not describe this capability as Soundwave-powered or Soundwave integration.
...
- Do not derive current direction from Gate 1–4 Confluence locks, the "Corrected IA," or v9–v15 sitemap sections. Those are historical references superseded by v16.

## Sitemap sync rule

Any change to routes, navigation, or IA must bump the FigJam sitemap version on board `oen38yFKbFtgqx9LQKn38Y` in the same working session (current: v16). A stale sitemap caused costly direction swings; do not skip this.
...
- Use **My Home**, **Entertainment Hub**, **Professional**, **release**, **product**, **franchise**, **world**, **character**, and **My Library** consistently with their v16 meanings.
...
- FigJam: CrypticDesign.net Sitemap v16 — `figma.com/board/oen38yFKbFtgqx9LQKn38Y`, section `81:2660`
