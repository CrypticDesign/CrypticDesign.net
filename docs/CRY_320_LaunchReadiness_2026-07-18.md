...
- Severity 2: none known in the verified local launch-critical path after restoring Account and Search to responsive primary navigation and excluding local sandbox data from the package.
